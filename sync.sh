...
git_init(){
    git config --global user.name "mengnanpeter"
    git config --global user.email mengnanpeter@gmail.com
    git remote rm origin
    git remote add origin git@github.com:mengnanpeter/gcr_sync.git
    git pull
